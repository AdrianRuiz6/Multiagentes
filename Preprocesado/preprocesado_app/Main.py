...
def data_clean():
    ...
    xl = pd.read_csv(excel, sep = ';', decimal = ',', encoding='iso8859_15')
    ...
    data5.rename(columns = {'countriesandterritories' : 'pais',
                        ...
                        'cumulative_cases_per_100000' : 'incidencia_acumulada'
                        }, inplace = True)
